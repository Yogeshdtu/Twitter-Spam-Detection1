...
int main()
{
    ...
    while(!fp.eof())
    {
        ...
        if(c=='"')
        {
            ...
            if(s=="followers_count" && no_of_followers_done==0)
            {
                char c;
                c=fp.get();
            ...
            if(s=="friends_count" &&no_of_following_done==0)
            {
                char c;
                c=fp.get();
            ...
            if(s=="listed_count" &&no_of_lists_done==0)
            {
                char c;
                c=fp.get();
            ...
            if(s=="favourites_count" &&no_of_favourites_done==0)
            {char c;
                c=fp.get();
            ...
            if(s=="statuses_count" && no_of_status_done==0)
            {char c;
                c=fp.get();
             ...
             if(s=="retweet_count" && no_of_retweets_done==0)
            {
                char c;
                c=fp.get();
